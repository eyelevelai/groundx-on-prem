...
- [ ] 1.1 In `src/groundx/templates/app/celery.yaml`, change the three
...
- [ ] 1.2 Apply the identical edit to the manual mirror
...
- [ ] 2.1 Run the full `helm unittest src/groundx` golden-snapshot suite and
  ...
  its result verbatim.
- [ ] 2.2 Record in the PR/commit body that no `values.yaml`,
