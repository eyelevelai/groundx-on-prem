...
- [x] 3.5 Add enabled Kafka and SQS snapshots to the existing golang, resources and stream suites using the shared large-file values fixture. Move field assertions into those suites, remove the separate suite, and preserve all existing snapshots.
