# workspace-ownership-config Specification

## Purpose
Define the Helm setting that controls workspace-runner ownership enforcement, its safe
default, rendered configuration, validation, and compatible rollout order.
