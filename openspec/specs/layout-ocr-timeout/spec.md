# layout-ocr-timeout Specification

## Purpose
TBD - created by archiving change gx-6-expose-ai-server-ocr-timeout-ocrtimeout-in-the-helm-chart. Update Purpose after archive.
## Requirements
