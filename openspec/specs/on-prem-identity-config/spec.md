# on-prem-identity-config Specification

## Purpose
TBD - created by archiving change gx-20-on-prem-has-no-identity-provider-servergroundx-wires-a-mock. Update Purpose after archive.
## Requirements
