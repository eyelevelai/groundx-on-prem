# anthropic-workflow-engine-service Specification

## Purpose

Preserve explicit summary and extraction engine settings, including native
Anthropic, through the existing Helm configuration. Keep legacy service-key
compatibility, shared defaults and runtime-image compatibility requirements.
