# local-identity-mode-config Specification

## Purpose
TBD - created by archiving change gx-53-provide-a-planned-and-approved-local-password-login-option. Update Purpose after archive.
## Requirements
