# workspace-managed-data Specification

## Purpose
Define the disabled-by-default Helm configuration for Workspace managed data,
including provider settings, secret-backed administrator credentials, and
matching source and published chart contracts.
