# credential-secret-paths Specification

## Purpose
TBD - created by archiving change gx-17-groundx-helm-chart-add-kubernetes-secret-paths-for-all. Update Purpose after archive.
## Requirements
