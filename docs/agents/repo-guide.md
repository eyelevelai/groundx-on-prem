# groundx-on-prem Repo Guide

This is the detailed repo guide for agents and humans. `AGENTS.md` is the short
table of contents; use this guide for the Helm/on-prem model, editable paths,
privileged-operation boundaries, OpenSpec workflow, and repo gotchas.
